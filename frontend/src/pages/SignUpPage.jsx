...
const SignUpPage = () => {
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
                    ...
                    <form onClick={handleSubmit} className="space-y-6">
                        ...
                        <div className="form-control">
                            ...
                            <div className="relative">
                                ...
                                type="email"
                                className="input input-bordered w-full pl-10"
                                placeholder="abhishekaj0803@gmail.com"
                        ...
                        <button type="submit" className="btn btn-primary w-full" disabled={isSigningUp}>
                            {isSigningUp ? <><Loader className="size-5 animate-spin"/> Loading </> : "Create Account"}
                        </button>
                    </form>
            ...
            subtitle="Connect with me, share moments, and stay in touch with me"/>
